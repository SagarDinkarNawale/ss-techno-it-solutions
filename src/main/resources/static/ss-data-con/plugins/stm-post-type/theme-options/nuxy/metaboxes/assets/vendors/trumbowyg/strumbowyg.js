    ...
    function(e, t, n, a) {
        ...
        var i = function(o, r) {
            var i = this,
                s = "trumbowyg-icons",
                l = a.trumbowyg;
            i.doc = o.ownerDocument || n, i.$ta = a(o), i.$c = a(o), null != (r = r || {}).lang || null != l.langs[r.lang] ? i.lang = a.extend(!0, {}, l.langs.en, l.langs[r.lang]) : i.lang = l.langs.en, i.hideButtonTexts = null != l.hideButtonTexts ? l.hideButtonTexts : r.hideButtonTexts;
            var d = null != l.svgPath ? l.svgPath : r.svgPath;
            if (i.hasSvg = !1 !== d, !1 !== d && (l.svgAbsoluteUseHref || 0 === a("#trumbowyg-icons", i.doc).length)) {
                if (null == d) a("script[src]").each((function(e, t) {
                    var n = t.src,
                        a = n.match("trumbowyg(.min)?.js");
                    null != a && (d = n.substring(0, n.indexOf(a[0])) + "../../assets/vendors/ui/icons.svg")
                }));
                if (null == d) console.warn("You must define svgPath: https://goo.gl/CfTY9U");
                    ...
                    c.id = s, i.doc.body.insertBefore(c, i.doc.body.childNodes[0]), a.ajax({
                        async: !0,
                        type: "GET",
            ...
            i.btnsDef = {
                ...
                i.addBtnDef(e, t)
            })), i.eventNamespace = "trumbowyg-event", i.keys = [], i.tagToButton = {}, i.tagHandlers = [], i.pasteHandlers = [].concat(i.o.pasteHandlers), i.isIE = -1 !== e.userAgent.indexOf("MSIE") || -1 !== e.appVersion.indexOf("Trident/"), i.isMac = -1 !== e.platform.toUpperCase().indexOf("MAC"), i.init()
        };
        i.prototype = {
            ...
            buildBtn: function(e) {
                var t = this,
                    ...
                    l = a("<button/>", {
                        ...
                        tabindex: -1,
                        mousedown: function() {
                            return r && !a("." + e + "-" + n + "dropdown", t.$box).is(":hidden") || a("body", t.doc).trigger("mousedown"), !((t.$btnPane.hasClass(n + "disable") || t.$box.hasClass(n + "disabled")) && !a(this).hasClass(n + "active") && !a(this).hasClass(n + "not-disable")) && (t.execCmd((!r ? o.fn : "dropdown") || e, o.param || e, o.forceCss), !1)
                        }
                    });
                if (r) {
            ...
            semanticTag: function(e, t, n) {
                ...
                n && (e = o, o = i), a(e, this.$ed).each((function() {
                    ...
                    })), i.html(n.html()), n.remove(), !0 === e && (r.range.selectNodeContents(i.get(0)), r.range.collapse(!1))
                }))
            },
            createLink: function() {
                for (var e, t, n, o = this, r = o.doc.getSelection(), i = r.getRangeAt(0), s = r.focusNode, l = (new XMLSerializer).serializeToString(i.cloneContents()) || i + "", d = o.o.linkTargets[0];
            ...
            fullscreen: function() {
                var e, n = this,
                    ...
                    i = r + "-placeholder",
                    s = n.$box.outerHeight();
                n.$box.toggleClass(r), (e = n.$box.hasClass(r)) ? n.$box.before(a("<div/>", {
                    class: i
                }).css({
                    height: s
            ...
            openModal: function(e, n, i) {
                ...
                var d, c = a("<div/>", {
                    ...
                    u = l + "dark";
                0 !== s.$c.parents("." + u).length && c.addClass(u), s.$overlay.one("click", (function() {
                ...
                return e && a("<span/>", {
                    text: e,
                    class: l + "modal-title"
                }).prependTo(g), i && (a(":input:first", g).focus(), s.buildModalBtn("submit", g), s.buildModalBtn("reset", g), c.height(g.outerHeight() + 10)), a(t).trigger("scroll"), s.$c.trigger("tbwmodalopen"), c
            },
            ...
            openModalInsert: function(e, t, n) {
                ...
                return a.each(t, (function(e, t) {
                    ...
                    d += '<div class="' + s + 'input-row">', d += '<div class="' + s + 'input-infos"><label for="' + i + '"><span>' + (l[n] ? l[n] : n) + "</span></label></div>", d += '<div class="' + s + 'input-html">', a.isPlainObject(t.options) ? (d += '<select name="target">', d += Object.keys(t.options).map((e => '<option value="' + e + '" ' + (e === t.value ? "selected" : "") + ">" + t.options[e] + "</option>")).join(""), d += "</select>") : (d += '<input id="' + i + '" type="' + (t.type || "text") + '" name="' + o + '" ' + u, d += ("checkbox" === t.type && t.value ? ' checked="checked"' : "") + ' value="' + (t.value || "").replace(/"/g, "&quot;") + '">'), d += "</div></div>"
            ...
            addErrorOnModalField: function(e, t) {
                ...
                })), r.addClass(n + "input-error").find("." + n + "input-infos label").append(a("<span/>", {
                    class: o,
                    text: t
                }))
            },
